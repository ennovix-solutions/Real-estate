...
function initialize() {
    ...
    var markers = [
        ...
        ['piassa microlink, Dhaka, Bangladesh', 23.777628, 90.405449],
    ...
    var infoWindowContent = [
        ['<div class="info_content">' +
            '<h3 class="info_location_name">piassa microlink</h3>' +
            '<p class="info_location_text">piassa microlink </p>' +
            '<p class="info_location_call"><span><i class="fa fa-phone"></i></span>(251) 979348778</p>' +
        ...
        ['<div class="info_content">' +
            '<h3 class="info_location_name">piassa microlink</h3>' +
            '<p class="info_location_text">2105, piassa, microlink</p>' +
            '<p class="info_location_call"><span><i class="fa fa-phone"></i></span>(251) 979348778</p>' +
            '<a href="#" class="btn-link">View Location</a>' +
        ...
        ['<div class="info_content">' +
            ...
            '<p class="info_location_text">1012, piassa, microlink</p>' +
            '<p class="info_location_call"><span><i class="fa fa-phone"></i></span>(251) 979348778</p>' +
            '<a href="#" class="btn-link">View Location</a>' +
